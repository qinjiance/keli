...
<head>
<title><fmt:message key="webapp.title" /> - 水质健康</title>
<!-- meta -->
...
<body>
	...
	<div>
		...
		<p class="op">
			...
			<a href="${ctx}waterQMap" class="wp"><img src="${ctx}<fmt:message key="static.resources.host"/>/images/map.png" /><em class="de">水质地图</em></a>
		</p>
	</div>	
